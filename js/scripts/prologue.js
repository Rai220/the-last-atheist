...
monogatari.script ({
	...
	'Prologue_Apartment': [
		...
		'Под постом — 14 сердечек от тёти Вали и молчаливое неодобрение остальных.',

		{
			'Choice': {
				'Dialog': 'mc (Палец завис над клавиатурой...)',
				'mock': {
					'Text': 'Уничтожить аргументом',
					'Do': 'jump Prologue_Mock',
					'onChosen': function () {
						this.storage ({ humor_used: this.storage ().humor_used + 1, denial_count: this.storage ().denial_count + 1 });
					}
				},
				'ignore': {
					'Text': 'Промотать',
	...
	'Prologue_Mock': [
		'mc «Серёг, корреляция — не каузация. Спина прошла потому что прошёл год, а не потому что ты разговаривал с потолком. С тем же успехом мог благодарить кактус на подоконнике.»',

		'Тридцать секунд. Лайк от Маши-биолога. Три дизлайка от тёти Вали — с разных аккаунтов.',

		'mc (Тётя Валя завела три аккаунта ради дизлайков. Вот это вера.)',
