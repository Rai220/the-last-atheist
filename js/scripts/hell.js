...
monogatari.script ({
	...
	'Hell_Exploration': [
		...
		'На одной из дверей — рыжая лисья маска. Детская. Просто висит на гвозде.',
		'mc (Странная маска. Что она тут делает? Детская, звериная...)',
		'mc (Лучше не трогать. От неё... холодом тянет.)',

		'Мимо проходит демон с коробкой.',
		'За ним — другой демон, с точно такой же коробкой. И за ним — ещё один.',
		'Все три идут с одинаковой скоростью. С одинаковым выражением лица.',

		'mc (Три одинаковых демона. Одинаковые коробки. Одинаковая скорость.)',
		'mc (Как три копии одного NPC.)',
