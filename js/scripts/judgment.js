...
monogatari.script ({
	...
	'Judgment_Queue': [
		...
		'А рядом — высокий мужчина в очках, с рюкзаком, на котором значок ДНК. Нервно протирает очки.',
		'mc (Этот выглядит как учёный. Биолог? Генетик?)',
		'Мужчина замечает Алексея. Его глаза расширяются.',
		'soul Вы тоже?! Вы тоже атеист?!',
		'mc ...Да.',
		'soul Боже... то есть... ну... Это невозможно! Я писал книги! Я объяснял когнитивные искажения! Я десятки лекций прочитал про то, что это всё нейробиология!',
		'soul И вот я тут. ЗДЕСЬ. В очереди на СТРАШНЫЙ СУД.',
		'mc (Он популяризатор науки? Тут? Если даже ОН попал сюда...)',
		'soul Знаете, что самое обидное? Я же знал, что confirmation bias существует. И всё равно не допускал, что ошибаюсь.',
