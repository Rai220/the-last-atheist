...
monogatari.script ({
	...
	'Judgment_Queue': [
		...
		'Очередь движется на удивление быстро. Как в МФЦ, если бы в МФЦ работали ангелы с огненными мечами.',

		'Вокруг — люди. Ну, души людей. Разного возраста, эпох, национальностей.',
		'Рядом — мужчина в тоге. За ним — женщина в платье XVIII века. За ней — подросток в худи.',
