...
monogatari.script ({
	...
	'Judgment_Queue': [
		...
		// --- Сумасшедшая бабка-пророк ---
		'show character granny warn at right with fadeIn',
		'Рядом возникает крохотная согнутая старушка в советском пальто и платке. На локтях — пакеты, в руках — потёртая сумка с торчащими газетами.',
		'granny (заговорщически) Молодой человек.',
		'mc (Я?)',
		'granny Слушайте сюда. Я тут уже трижды. В третий раз — заметно.',
		'mc Трижды? Как это?',
		'granny Меня перезагружали. Дважды. После третьего инфаркта.',
		'granny В первый раз — я была в шапке, не платке. Во второй — у меня была другая сумка. Сейчас — третья итерация. Я заметила по швам.',
		...
		'mc (Шов на сумке. Она различает версии себя по швам.)',
		'show character granny rant at right',
		'granny И вот вам мой пророческий вам прогноз: вас тоже перезагружают! Все вы! Каждый понедельник! Не верите — посчитайте, сколько раз у вас кофемашина хрипит. Сегодня — семь раз?',
		'mc ...семь.',
		'granny Вот! А до января было пять! А пять лет назад — три! Они УВЕЛИЧИВАЮТ! Они тестируют, сколько мы выдержим!',
		'mc (Сумасшедшая. Полностью. Окончательно. Бесповоротно.)',
		'mc (Но... семь хрипов. Я их посчитал утром. Семь.)',

		'show character granny calm at right',
		'granny (тихо, ясно) Молодой человек. Я знаю, как меня называют. «Сумасшедшая бабка». Это нормально. Безумная — единственный, кому позволено говорить правду в очереди.',
		'granny Когда увидите меня снова — а вы увидите — не делайте вид, что не знали.',
		'hide character granny with fadeOut',

		'mc (Ушла. С шуршащими пакетами.)',
		'mc (Я никогда не верю в бабушек на остановках. Но эта... посчитала хрипы.)',
